...
<body>
    ...
    <nav class="navbar navbar-expand-md">
        <ul class="navbar-nav">
            ...
            <form method="post" name="doctorlogoutform" action="doctorlogout" class="nav-item">
    ...
    <div class="main-content">
        ...
        <p>Here you can manage your appointments, view patient records, and update your availability.</p>
    </div>
